 ...
 * The script saves the .PV file to local C drive where a hot folder is located.
 * The hotfolder will automatically upload the .PV file to Azure.
 * Afterwards the file will be saved in the designated Vector Folder on the I: drive.
...
function main(){
    ...
    //***Export Pulse File  
    azDest = "C:\\Azure_Upload_Folder\\" + vectorName + prepName + ".pv";
    //$.write("Pulse: " + azDest + "\n")
